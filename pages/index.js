  ...
  return (
    <div className="bg-gray-100 min-h-screen flex flex-col font-sans">
      <nav className="bg-gradient-to-r from-blue-500 via-purple-500 to-indigo-500 py-4 px-6 w-full flex justify-between items-center shadow-lg">
        ...
        <a href="#contact" className="text-xl font-medium text-white hover:text-blue-300">
          Get in touch!
        </a>
      </nav>
              ...
              >
                <div className="mb-6 w-full">
                  ...
                  <input
                    ...
                    id="name"
                    type="text"
                    className="border-2 border-gray-300 px-4 py-2 w-full rounded-md focus:border-purple-500 focus:outline-none transition-colors"
                  />
                  {errors.name && (
                ...
                <button
                  type="submit"
                  className="bg-gradient-to-r from-blue-500 via-purple-500 to-indigo-500 text-white px-4 py-4 rounded-md hover:from-blue-400 hover:via-purple-400 hover:to-indigo-400 w-full"
                >
                  Send message
                </button>
                {isSuccess && (
      ...
      <footer className="bg-gray-800 text-white py-4 text-center">
        <p>
          &copy; {new Date().getFullYear()} Tristan Jarrett
        </p>
      </footer>
    </div>
  );
